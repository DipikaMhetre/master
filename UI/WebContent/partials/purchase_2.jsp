...
<div id="purch" data-ng-controller="PurchaseCtrl2" data-ng-init=init()>
...
HI
	...
	<div>
		...
		<Section class="pageheader">
			<nav class="mainnav">
				<ul class="leftFloat_Menu" id="list-nav">
					...
					<li><a href="#" title="" class="highlight_purple not_active">Purchase
							Order </a></li>


					<li><span class="glyphicon glyphicon-play newShowGlyphicon"></span>
					</li>
					<li><a ng-click="$parent.changeView(activeUser.userId,activeUser.token,1);" class="">Refresh</a></li>
					<li><a href="#" title="Email"
						class="not_implemented_link not_active">Email</a></li>
					<li><a title="Print" class="not_implemented_link not_active">Print</a></li>

					<%
						if(createPermission || modifyPermission){
					%>
					<li ng-show="showSaveBtn"><a ng-click=savePO(showPOSelected)
						title="Save">Save</a></li>
					<%
						}
					%>
					<%
						if(createPermission){
					%>
					<li><a ng-click="newPO()" title="Logout" class="">New</a></li>
					<%
						}
					%>
					...
					<!-- Temp code -->
					<!-- <li ng-show="showPrevNextBtn" class="editable_btnPos">
						<button type="button"
							class="btn btn-default flag_enable input-sm editable-btn"
							tabindex="20">
							<span class="fieldLeft_spacing_lg" ng-click="prevNext('prev')">Prev</span>
						</button>
					</li>
					<li ng-show="showPrevNextBtn" class="editable_btnPos">
						<button type="button"
							class="btn btn-default flag_enable input-sm editable-btn"
							tabindex="20">
							<span class="fieldLeft_spacing_lg" ng-click="prevNext('next')">Next</span>
						</button>
					</li> -->
				</ul>
		...
		<div class="row container">
			<h5>
				<span class="submenuBlue_heading">Purchase Order Summary</span> <span
			...
			<div class="row grid">
					...
					<div class="block3">
						...
						<div class="row fieldsSpacing fields_headingSpacing">
							<div class="col-md-8">
								<select id="companySelect"
									...
									data-ng-model="showPOSelected.cpoCompanyId"
									data-ng-options="opt.companyId as opt.companyName for opt in companyList | orderBy:'companyName'"
									ng-disabled="!editable || showPOSelected.cpoId !='New#PO'"
									tabindex="1">
						...
						<div class="row fieldsSpacing">
							<div class="col-md-8">
								<select
									class="select-wrapper input_rightSpecing full_width input-sm inputtext"
									data-ng-change="getProducts(showPOSelected.cpoCompanyId,showPOSelected.cpoSupplierId)"
									data-ng-model="showPOSelected.cpoSupplierId"
									data-ng-disabled="showPOSelected.cpoCompanyId ==0 || !editable || showPOSelected.cpoId !='New#PO'"
									data-ng-options="opt.supplierId as opt.supplierName for opt in supplierList | keywordFilter2:showPOSelected.cpoCompanyId"
									tabindex="2">
									<option value='' disabled selected style='display: none;'>Please
						...
						<div class="row fieldsSpacing">
							<div class="col-md-8">
								<select
									class="select-wrapper input_rightSpecing full_width input-sm inputtext"
									data-ng-model="showPOSelected.cpoMrId" data-ng-change=""
									data-ng-disabled="!companySelected || !editable"
									data-ng-options="opt.mrId as opt.mrName for opt in mrList"
									tabindex="3">
									<option value='' disabled selected style='display: none;'>Please
										select a MR</option>
								</select>
					...
					<div class="block3 goodsReceiptBlock3">
						...
						<div class="row ">
							<div class="col-md-4">
								<input type="text" id="new_PO"
									class="form-control input-sm purchase_orderDetails_col1 numberField"
									ng-blur="retrievePO(showPOSelected.cpoId)"
									data-ng-model=showPOSelected.cpoId tabindex="4">
							</div>
							<div class="col-md-4">
								<input type="eu-date" id="date"
									...
									data-ng-model=showPOSelected.cpoDate ng-readonly="!editable"
									tabindex="5">

							</div>
							<div class="col-md-4">
								<div class="input-group input-group_width ">
									<input type="text"
										class="form-control input-sm purpleBG highlight_white numberField"
										disabled data-ng-model=showPOSelected.cpoAmount> <span
						...
						<div class="row">
							<div class="col-md-4 GR_orderDetailsText_fieldspacing">
								<span class="GR_orderDetailsFont">PO#</span>
							</div>
							<div class="col-md-4 GR_orderDetailsText_fieldspacing">
								<span class="GR_orderDetailsFont">PO&nbsp;Date</span>
							</div>
							<div class="col-md-4 GR_orderDetailsText_fieldspacing">
								<span class="GR_orderDetailsFont">Net&nbsp;Amt</span>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-4 ">
								<!-- <input type="text"
									...
									readonly value=NEW> -->
									<select ng-model="showPOSelected.cpoStatus" ng-options="opt.id as opt.name for opt in statusList"disabled class="form-control PO_details_inputSize input-sm" ></select>
							...
							<div class="col-md-4">
								<input type="text"
									...
									readonly value={{orderDetails.cpoNoOfTasks}}
									data-ng-model=orderDetails.cpoNoOfTasks>
							...
							<div class="col-md-4">
								<input type="text"
									class="form-control input-sm PO_details_inputSize numberField not_implemented"
									readonly value={{showPOSelected.cpoNoOfItems}}
									data-ng-model=showPOSelected.cpoNoOfItems>
						...
						<div class="row">
							<div class="col-md-4 GR_orderDetailsText_fieldspacing">
								<span class="GR_orderDetailsFont">Status</span>
							</div>
							<div class="col-md-4 GR_orderDetailsText_fieldspacing">
								<span class="GR_orderDetailsFont">Tasks</span>
							</div>
							<div class="col-md-4 GR_orderDetailsText_fieldspacing">
								<span class="GR_orderDetailsFont">Items</span>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-10">
								<input type="text"
									...
									data-ng-model=showPOSelected.cpoRemark ng-readonly="!editable"
									tabindex="6">
							</div>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="block3">
						...
						<div class="row fieldsSpacing fields_headingSpacing">
							<div class="col-md-3">
								<button id="orderFlagEmail"
									ng-model="showPOSelected.cpoEmailFlag" type="button"
									ng-class="showPOSelected.cpoEmailFlag?'flagselected' : ''"
									ng-click="changeFlag('email')" ng-disabled="!editable"
								...
								<div class="row">
									<div class="col-md-6 flagLeftSpacing">
										<button id="orderFlagStopOpen" type="button"
											ng-model="showPOSelected.cpoCancelPendingFlag"
											ng-class="showPOSelected.cpoCancelPendingFlag?'flagselected' : ''"
											ng-click="changeFlag('cpoCancelPendingFlag')"
									...
									<div class="col-md-6 flagRightSpacing">
										<button type="button" id="orderFlagScheme"
											ng-model="showPOSelected.cpoSchemeFlag"
											ng-class="showPOSelected.cpoSchemeFlag?'flagselected' : ''"
											ng-click="changeFlag('scheme')" ng-disabled="!editable"
						...
						<div class="row fieldsSpacing rowSpacing">
							<div class="col-md-3">
								<button type="button" id="orderFlagUrgent"
									ng-model="showPOSelected.cpoUrgentFlag"
									ng-class="showPOSelected.cpoUrgentFlag?'flagselected' : ''"
									ng-disabled="!editable" ng-click="changeFlag('urgent')"
						...
						<div class="row fieldsSpacing">
							<div class="col-md-3">
								<button id="orderFlagVoid"
									ng-class="showPOSelected.cpoVoidFlag?'flagselected' : ''"
									type="button" ng-model="showPOSelected.cpoVoidFlag"
									ng-click="changeFlag('void')"
									ng-disabled="!editable || <%=!deletePermission%>"
									class="btn flag_enable  btn_small input-sm" tabindex="11">
									<span class="fieldLeft_spacing_lg">Void</span>
								</button>
							</div>
							<div class="col-md-9 ">
								<input type="text" ng-disabled=!showPOSelected.cpoVoidFlag
									class="form-control input-sm" ng-model=showPOSelected.cpoVoidText
									tabindex="12">
							</div>
						</div>
					</div>
				...
				<div class="col-md-9 col-sm-9 textRight">
					<nav class="mainnav">
						<ul class="rightFloat" id="list-nav">
							<li ng-show="showSelectedFlag=='ON'"><a
								ng-click="cancelAllFilters()" title="Add Product">Add
									Product</a></li>
							<li><a ng-click="showPopup(selectedRecord)"
								ng-class="selectedRecid==0?'not_active not_implemented_link':''"
								title="Enter Quantity">Enter Quantity</a></li>
							<!-- <li><a href="#" title="Filter"
								class="not_active not_implemented_link">Filter(ON)</a></li> -->
							<li><a
								ng-class="!editable?'not_active not_implemented_link':''"
								ng-click="toggleEdited()" title="Show Selected">Show
									Selected(<span
...
<%if(createPermission && !modifyPermission){%>
	angular.element(document.getElementById('purch'))
