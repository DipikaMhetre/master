...
<div id="PO_Register" data-ng-controller="PO_RegisterCtrl"
	ng-init=init()>
	...
	<Section class="pageheader">
		<nav class="mainnav">
			<ul class="leftFloat_Menu" id="list-nav">
				<li><a href="#" title="  " class="highlight_purple not_active">Purchase Order
						Register</a></li>
				<li><span class="glyphicon glyphicon-play newShowGlyphicon"></span></li>
				<li><a ng-click="$parent.changeView(activeUser.userId,activeUser.token,124);" title="Start Over" class="">Refresh</a></li>
				<li><a title="Export" 
				...
				<li><a ng-click="goToPurchase()">New</a></li>				
				<li><a  title="Help"
				...
				<nav class="mainnav">
					<ul class="leftFloat" id="list-nav">
						<li class="returnReg_headingPos"><span
							class="masterTop_StripText">Purchase&nbsp;Order</span></li>
					</ul>
				</nav>
			</div>
			...
			<div class=" BottomSection">
				<div class="ShowNextPad rightFloat">
					<div class=" showNextPos">
						...
						<button ng-click="getFreshPoDetails()"
	...
	$(function() {
		$('#grid1').w2grid({
			...
			columns : [ 
			            ...
			            { field : '', caption : 'PO#', size : '5%'},
			            { field : '', caption : 'Amount', size : '6%'},
			            { field : '', caption : 'Items', size : '4%'},
			            { field : '', caption : 'Supplier', size : '10%'},
			            { field : '', caption : 'MR', size : '10%'},
			            { field : '', caption : 'Status', size : '7%'},
			            { field : '', caption : 'Urgent', size : '4%'},
			            { field : '', caption : 'Void', size : '4%'},
