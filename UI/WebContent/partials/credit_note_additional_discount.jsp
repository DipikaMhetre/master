<title>Credit
						Note - Additional Discount</title>

<%@page import="java.util.ArrayList"%>
<%@page import="com.purpleaid.beans.PurpleaidACL"%>
<%@page import="java.util.List"%>
<div id="CreditNoteAdditionalDiscount" ng-controller="CreditNoteAdditionalDiscountCtrl"
	...
	<Section class="pageheader">
		<nav class="mainnav">
			<ul class="leftFloat_Menu" id="list-nav">
				...
				<li><a ng-click="$parent.changeView(activeUser.userId,activeUser.token,131);" class="">Refresh</a></li>
				<li><a href="#" class="not_implemented_link not_active">Email</a></li>
				<li><a href="#" class="not_implemented_link not_active">Print</a></li>
				<!-- || showCNASelected.creditNoteVerifiedFlg -->
				<li><a
					ng-class="(!editable || showCNASelected.creditNoteType==2 )?'not_active not_implemented_link':''"
					ng-click="save(showCNASelected)" tabindex="19">Save</a></li>
	...
	<div class="row container">
		<h5>
			<span class="submenuBlue_heading">Credit Note - Additional Discount
				Summary</span>
					...
					<div class="row fields_headingSpacing fieldsSpacing">
						...
						<div class="col-md-10">
							<input type="text"
								...
								readonly="readonly"
								ng-model="showCNASelected.creditNoteTypeDescription">
						</div>
					</div>
					<div class="row fieldsSpacing">
						...
						<div class="col-md-8">
							<input type="text" id="customer" required="required"
								...
								disabled tabindex="2"
								ng-model="showCNASelected.creditNoteCustName">
						</div>
						<div class="col-md-2 textRight">
							<a ng-class="(!editable || showCNASelected.creditNoteVerifiedFlg || showCNASelected.creditNoteflgLock  ||showCNASelected.creditNoteType==2)?'not_active not_implemented_link':''"><img class="goodreturn_customerPopup_img "
					...
					<div class="row fieldsSpacing">
						...
						<div class="col-md-4">
							<input type="text"
								...
								tabindex="1" ng-model="showCNASelected.creditNoteID"
								ng-blur="retrieve(showCNASelected.creditNoteID)">
						</div>
						<div class="col-md-2 textLeft">
						...
						<div class="col-md-4">
							<input type="eu-date"
								...
								ng-model="showCNASelected.creditNoteDate">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row fieldsSpacing fields_headingSpacing">
						...
						<div class="col-md-10">
							<input type="text"
								...
								readonly="readonly"
								ng-model="showCNASelected.creditNoteStatusDescription">
						</div>
					</div>
					...
					<div class="row fieldsSpacing">
						...
						<div class="col-md-10">
							<input type="text"
								class="form-control input-sm goodReturn_lgInput"
								readonly="readonly"
								value="[{{showCNASelected.creditNoteCreatedByName}}] {{showCNASelected.creditNoteCreatedOn}}">
						</div>
					</div>
					<div class="row fieldsSpacing">
						<div class="col-md-2 textLeft">
						...
						<div class="col-md-10">
							<input type="text"
								...
								ng-model="showCNASelected.creditNoteRemark">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<nav class="mainnav">
					<ul class="rightFloat" id="list-nav">
						...
						<li><!--  --><a ng-class="(enableModifyBtn)?'':'not_active not_implemented_link'"
