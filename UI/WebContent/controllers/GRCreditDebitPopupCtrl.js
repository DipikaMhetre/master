pharmApp.controller('GRCreditDebitPopupCtrl', ['$scope','$rootScope','$http','$modalInstance','$log', function ($scope,$rootScope,$http, $modalInstance, $log,noteType) {
	$scope.init = function(){
		$scope.type=noteType;
		alert($scope.type);
		var config = {
				...
				grid: { 
					...
					columns: [
					          { field: '', caption: ' ', size: '3%' }, 
					          { field: 'productName', caption: 'Product Name', size: '10%' }, 
					          { field: 'pack', caption: 'Pack', size: '5%' },
					          { field: 'company', caption: 'Company', size: '7%'},
					          { field: 'batch#', caption: 'Batch#', size: '5%' },
					          { field: 'quantity', caption: 'Quantity', size: '6%' },
					          { field: 'free', caption: 'Free', size: '5%'},
					          { field: 'mrp', caption: 'MRP', size: '10%' },
					          { field: 'trade', caption: 'Trade', size: '10%' },
					          { field: 'vatAmt', caption: 'VAT Amt', size: '10%' },
					          { field: 'rate', caption: 'Rate', size: '10%' },		          		            
					          { field: 'value', caption: 'Value', size: '10%' },
					          { field: 'po#', caption: 'PO#', size: '8%' },
					          { field: 'diff', caption: 'Diff', size: '5%' },
					          ],
					          sortData: [
