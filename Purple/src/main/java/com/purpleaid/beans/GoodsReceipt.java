...
public class GoodsReceipt {
	...
	boolean goodsReceiptLedgerFlag;
	
	double goodsReceiptLedgerById;
	
	String goodsReceiptLedgerUserName;
	
	String goodsReceiptLedgerOn;
	
	boolean goodsReceiptStockFlag;
	
	double goodsReceiptStockById;
	
	String goodsReceiptStockUserName;
	
	String goodsReceiptStockOn;
	...
	String goodsReceiptVerifiedByName;
	 ...
	 String goodReceiptTransporterName;
	 
	 double goodsReceiptCreatedByID;
	 
	 String goodsReceiptCreatedByName;
	 
	double recid;
	
	
	public boolean isGoodsReceiptLedgerFlag() {
		return goodsReceiptLedgerFlag;
	}

	public void setGoodsReceiptLedgerFlag(boolean goodsReceiptLedgerFlag) {
		this.goodsReceiptLedgerFlag = goodsReceiptLedgerFlag;
	}

	public double getGoodsReceiptLedgerById() {
		return goodsReceiptLedgerById;
	}

	public void setGoodsReceiptLedgerById(double goodsReceiptLedgerById) {
		this.goodsReceiptLedgerById = goodsReceiptLedgerById;
	}

	public String getGoodsReceiptLedgerUserName() {
		return goodsReceiptLedgerUserName;
	}

	public void setGoodsReceiptLedgerUserName(String goodsReceiptLedgerUserName) {
		this.goodsReceiptLedgerUserName = goodsReceiptLedgerUserName;
	}

	public String getGoodsReceiptLedgerOn() {
		return goodsReceiptLedgerOn;
	}

	public void setGoodsReceiptLedgerOn(String goodsReceiptLedgerOn) {
		this.goodsReceiptLedgerOn = goodsReceiptLedgerOn;
	}

	public boolean isGoodsReceiptStockFlag() {
		return goodsReceiptStockFlag;
	}

	public void setGoodsReceiptStockFlag(boolean goodsReceiptStockFlag) {
		this.goodsReceiptStockFlag = goodsReceiptStockFlag;
	}

	public double getGoodsReceiptStockById() {
		return goodsReceiptStockById;
	}

	public void setGoodsReceiptStockById(double goodsReceiptStockById) {
		this.goodsReceiptStockById = goodsReceiptStockById;
	}

	public String getGoodsReceiptStockUserName() {
		return goodsReceiptStockUserName;
	}

	public void setGoodsReceiptStockUserName(String goodsReceiptStockUserName) {
		this.goodsReceiptStockUserName = goodsReceiptStockUserName;
	}

	public String getGoodsReceiptStockOn() {
		return goodsReceiptStockOn;
	}
	...
	public void setGoodsReceiptStockOn(String goodsReceiptStockOn) {
		this.goodsReceiptStockOn = goodsReceiptStockOn;
	}

	public String getGoodReceiptTransporterName() {
		return goodReceiptTransporterName;
	}

	public void setGoodReceiptTransporterName(String goodReceiptTransporterName) {
		this.goodReceiptTransporterName = goodReceiptTransporterName;
	}

	public double getGoodsReceiptCreatedByID() {
		return goodsReceiptCreatedByID;
	}

	public void setGoodsReceiptCreatedByID(double goodsReceiptCreatedByID) {
		this.goodsReceiptCreatedByID = goodsReceiptCreatedByID;
	}

	public String getGoodsReceiptCreatedByName() {
		return goodsReceiptCreatedByName;
	}

	public void setGoodsReceiptCreatedByName(String goodsReceiptCreatedByName) {
		this.goodsReceiptCreatedByName = goodsReceiptCreatedByName;
	}
